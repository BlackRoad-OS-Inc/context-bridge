...
**Context Bridge — Persistent memory layer for AI assistants. Chrome extension + CLI + Cloudflare Workers. Cross-session context for ChatGPT, Claude, and custom LLMs.**
